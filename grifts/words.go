...
// 	_ = grift.Add("info", func(c *grift.Context) error {
// 		fmt.Println(c.Args)
// 		return nil
// 	})
//
// 	_ = grift.Desc("skip", "Show skip words")
// 	_ = grift.Add("skip", func(c *grift.Context) error {
// 		// skips := readSkipWords()
// 		// fmt.Print(skips)
// 		return nil
// 	})
//
// 	_ = grift.Desc("merge", "Show merge words")
// 	_ = grift.Add("merge", func(c *grift.Context) error {
// 		merge := readMergeWords()
// 		fmt.Print(merge)
// 		return nil
// 	})
//
// 	_ = grift.Desc("jieba", "Extract words from files")
// 	_ = grift.Add("jieba", func(c *grift.Context) error {
// 		sugar := base.Sugar()
//
...
// 		entry := fileWords{
// 			Name:  i.Name,
// 			Words: parseFile(i.FullPath, x, mergeData),
// 		}
...
// 		// delete all
// 		_, err = tx.Store.Exec("truncate table words; ")
// 		if err != nil {
...
// func parseFile(file string, eng *gojieba.Jieba, mergeData map[string]string) []kv {
// 	// get txt from docx
// 	input := getText(file)
//
// 	// jieba
